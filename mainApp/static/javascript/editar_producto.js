...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        .then(data => {
            if (data.success) {
                // Redirigir a visualizar_productos
    ...
    /**
     * Función para iniciar y manejar el escáner de código de barras
     */
    if (btnEscanear) {
        btnEscanear.addEventListener('click', function() {
            interactiveViewport.style.display = 'block'; // Mostrar el contenedor del escáner
            Quagga.init({
                inputStream: {
                    name: "Live",
                    type: "LiveStream",
            ...
            Quagga.onDetected(function(data) {
                ...
                interactiveViewport.style.display = 'none'; // Ocultar el contenedor del escáner
            });
        });
    }
});
